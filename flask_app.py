...
def predict():
    ...
    # Predict
    knn_prediction = knn_model.predict(user_data_scaled)    
    logistic_regression_prediction = logistic_regression_model.predict(user_data_scaled)
    rf_prediction = rf_model.predict(user_data_scaled)
